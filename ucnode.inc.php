...
$ucs['serveraddr'] = 'http://127.0.0.1/s3st14_dev/ucs'; // UCS server address. NO TRAILING SLASH! for local testing on Windows machine don't use localhost, use 127.0.0.1 instead
